...
function Detail() {
  ...
  const addToCart = () => {
    ...
    if (itemInCart) {
      // increment qty on same item in cart
      dispatch({
  ...
  }, [products, data, loading, dispatch, id]); // dependency array: hook's functionality only runs when it detects changes in values from the array
